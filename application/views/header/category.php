...
<div class="navbar navbar-dark bg-dark">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="col-md-8">
    <div class="row">
    <div class="col-6"> <h3>Category(<?php echo sizeof($user);?>)</h3></div>  
        <hr>
           ...
           <thead>
              ...
              <?php if(!empty($user)) { foreach($user as $use) {  ?>
               <tr>
                  ...
                  <td>
                     <a href="<?php echo base_url('admin/delete/'.$use['id']);?>"  class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                  </td>
                 <td>
                     <a href="<?php echo base_url('admin/editcategory/'.$use['id']);?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                 </td>
               </tr>
               <?php } } ?>
               </tbody>
...
$('#createcategory').submit(function(e){
       ...
       $.ajax({
            url: "<?php echo base_url('admin/insertcategorys'); ?>",   
