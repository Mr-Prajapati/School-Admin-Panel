...
<div class="navbar navbar-dark bg-dark">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="col-md-8">
    <div class="row">
    <div class="col-6"> <h3>Class(<?php echo sizeof($user);?>)</h3></div>  
        <hr>
           ...
           <thead>
              ...
              <?php if(!empty($user)) { foreach($user as $use) {  ?>
               <tr>
                  ...
                  <td>
                     <a href="<?php echo base_url('admin/deleteclass/'.$use['id']);?>"  class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                  </td>
                 <td>
                     <a href="<?php echo base_url('admin/editclass/'.$use['id']);?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                 </td>
               </tr>
               <?php } } ?>
               </tbody>
  ...
  <div class="modal-dialog" role = "document" >
      <div class="modal-content ">
         <div class="modal-header ">
           <h5 class="modal-title "  id="staticBackdropLabel">Add New Classes</h5>
...
$('#createcategory').submit(function(e){
       ...
       $.ajax({
            url: "<?php echo base_url('admin/insertclass'); ?>",   
